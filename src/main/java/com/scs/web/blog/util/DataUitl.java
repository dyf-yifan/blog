...
public class DataUitl {
    ...
    public static int getUserid(){
        Random random = new Random();
        int userid = random.nextInt(72)+1;
        return userid;
    }
    ...
    public static String getAddress(){
       String[][] address = new String[][]{
            ...
            {"西藏省", "阿里地区", "昌都地区", "拉萨市", "林芝地区", "那曲地区", "日喀则地区", "山南地区"},
            {"新疆省", "阿克苏地区", "阿勒泰地区", "巴音郭楞蒙古自治州", "博尔塔拉蒙古自治州", "昌吉回族自治州", "哈密地区", "和田地区", "喀什地区", "克拉玛依市", "克孜勒苏柯尔克孜自治州", "塔城地区", "吐鲁番地区", "乌鲁木齐市", "伊犁哈萨克自治州", "自治区直辖县级行政区划"},
    ...
    int num = address.length-1;
    Random random = new Random();
    int province = random.nextInt(num)%(num+1);
    int s = address[province].length-1;
    int city =random.nextInt(s)%(s)+1;

    return address[province][0]+address[province][city];
}
}
